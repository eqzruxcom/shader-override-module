...
if($manifest.mode -ne 'rebirth-contact-viewport-experiment-v1' -or $manifest.qualityGatePassed -ne $false -or $rollback.targetRoot -ne $prior.targetRoot){throw 'Wrong experiment receipt.'}
