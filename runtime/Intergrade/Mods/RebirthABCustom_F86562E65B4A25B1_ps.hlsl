  ...
  out float4 o0 : SV_Target0)
{
  ...
  // Scene-only saturation probe. This pass renders before the HUD is composed,
  // so the 3D scene should become grayscale while the UI remains colored.
  float sceneLuma = dot(r5.xyz, float3(0.2126, 0.7152, 0.0722));
  o0.xyz = sceneLuma.xxx;
  o0.w = 0;
  return;
}
