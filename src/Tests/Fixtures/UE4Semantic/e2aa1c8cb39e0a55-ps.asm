...
if_nz r1.x
  ...
  if_nz r12.w
    ...
    if_nz r4.w
      ...
      if_nz r5.x
        ...
        loop 
          ...
          if_nz r17.y
            ...
            if_nz r17.x
              ...
              sample_l_indexable(texturecubearray)(float,float,float,float) r17.xzw, r14.xyzw, t10.xwyz, s8, l(3.449748)
        ...
        mad r14.xyz, r15.xyzx, l(0.250000, 0.250000, 0.250000, 0.000000), r14.xyzx
  ...
  if_nz r1.y
    ...
    dp3 r9.w, r9.xyzx, l(0.333333, 0.333333, 0.333333, 0.000000)
    ...
    if_nz r8.z
      ...
      dp3 r2.w, r9.xyzx, l(0.333333, 0.333333, 0.333333, 0.000000)
      ...
      if_nz r1.x
        ...
        if_nz r8.w
          ...
          mul r6.xyz, r8.xzwx, l(0.785398, 0.785398, 0.785398, 0.000000)
          ...
          mul r7.xyw, r0.xyxz, l(0.785398, 0.785398, 0.000000, 0.785398)
        else 
          if_nz r7.z
            dp3 r9.w, r9.xyzx, l(0.333333, 0.333333, 0.333333, 0.000000)
            ...
            sqrt r1.x, r8.y
            mad r1.x, r1.x, l(-0.495000), l(0.636000)
            mul r0.xyz, r0.xyzx, r1.xxxx
            mad r1.x, r8.y, l(-0.633000), l(0.200000)
