...
if($manifest.mode -ne 'rebirth-contact-left-edge-profile-experiment-v2' -or $manifest.qualityGatePassed -ne $false -or $rollback.targetRoot -ne $prior.targetRoot){throw 'Wrong experiment receipt.'}
