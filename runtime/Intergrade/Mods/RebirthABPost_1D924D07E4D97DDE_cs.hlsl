// Temporally compensated quarter-scattering post.
...
void main(uint3 threadID : SV_DispatchThreadID)
{
    ...
    static const float QUARTER_SCATTERING_HISTORY_SCALE = 0.6896551724;
    RebirthFogOutput[threadID] = float4(
        value.xyz * QUARTER_SCATTERING_HISTORY_SCALE,
        value.w);
}
